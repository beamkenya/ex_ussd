          ...
          true ->
            cond do
              api_parameters.text == "1" ->
                ...
                |> Map.put(
                  :title,
                  "New PIN should should not match with the previous 5 PIN's. Please keep your debit card with you for PIN reset.\nPress 1 to continue."
                )
